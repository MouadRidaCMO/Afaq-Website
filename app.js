...
en: {
    ...
    'hero.card1': 'Morocco · Hungary',
    'hero.card2': 'Stipendium Hungaricum',
    'hero.card3': 'Support from A to Z',
    ...
    'about.mouad.body': 'Holder of a master’s in Media and Digital Marketing from ELTE in Budapest, Mouad has followed the exact path he now guides others through: application, admission, settling in and student life in Hungary.',
    'about.aya.role': 'Co-founder',
    'about.aya.body': 'Based in Hungary, Aya is your first point of contact at AFAQ. She answers your messages, reviews your profile and guides you from the very first questions.',
...
ar: {
    ...
    'about.mouad.body': 'حاصل على ماستر في الإعلام والتسويق الرقمي من جامعة ELTE ببودابست، سلك معاد بنفسه المسار الذي يرافق فيه الطلبة اليوم: الترشيح، القبول، الاستقرار والحياة الطلابية في المجر.',
    'about.aya.role': 'شريكة مؤسِّسة',
    'about.aya.body': 'مقيمة في المجر، آية هي أول من يستقبلك في آفاق. هي من يجيب على رسائلك ويدرس ملفك ويرشدك منذ أول سؤال.',
